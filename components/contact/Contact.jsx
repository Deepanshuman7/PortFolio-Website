            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">deepanshumaan777@gmail.com</span>

                        <a href="mailto:deepanshumaan777@gmail.com" className="contact__button">Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">(+91) 8950636325</span>

                        <a href="https://api.whatsapp.com/send?phone=8950636325&text=Hello, I would like to connect with you!" className="contact__button"> Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>
            </div>
